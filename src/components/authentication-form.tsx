...
export default function AuthenticationForm() {
  ...
  const handleFormSubmit = async (e: FormEvent) => {
    ...
    if (isRegisterMode) {
      ...
      try {
        ...
        await handleSuccessfulLogin(userCredential.user, true, fullName);
      } catch (error: any) {
  ...
  if (isLoading && !email) { // Persist loading screen only on initial load / redirect
    return (
     ...
     <div className="min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-md">
            <div className="backdrop-blur-xl bg-white/10 rounded-3xl shadow-[0_20px_80px_-15px_rgba(0,0,0,0.4)] border border-white/10 overflow-hidden">
                ...
                <div className="p-8">
                     <h2 className="text-white text-2xl font-semibold mb-2">{isRegisterMode ? "Create Account" : "Welcome Back!"}</h2>
                     <p className="text-white/70 mb-6">{isRegisterMode ? "Enter your details to get started." : "Sign in to continue to your dashboard."}</p>
                     ...
                     <div className="relative my-6">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-white/10 backdrop-blur-sm px-2 text-white/70">Or continue with</span>
                        </div>
                    </div>
                    ...
                    <p className="mt-6 text-center text-sm text-white/70">
                        ...
                        <button onClick={() => setIsRegisterMode(!isRegisterMode)} className="font-semibold text-blue-400 hover:text-blue-300">
