...
export default function FacultyNavbar({ user }: FacultyNavbarProps) {
  ...
  const navItems = [
    ...
    { path: '/admin/calendar', label: 'Lab Timetable' },
    { path: '/admin/seminar-hall', label: 'Seminar Hall' },
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className='flex items-center space-x-2'>
             <div className="hidden md:block relative profile-dropdown-container">
                ...
                {isProfileDropdownOpen && (
                      <div className="absolute right-0 mt-2 w-48 py-1 bg-card/90 backdrop-blur-lg rounded-xl shadow-lg border border-border transition-all z-50">
